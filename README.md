...
A portfolio of T-SQL solutions to Danny Ma's [8-Week SQL Challenge](https://8weeksqlchallenge.com/), built in SQL Server
as part of my data engineering learning path. Each case study covers a distinct business domain with documented query
logic, data cleaning decisions, and production commentary.

---

## 📂 Selected Case Studies & Directory
